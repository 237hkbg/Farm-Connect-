...
import { User, Mail, Lock, Eye, EyeOff, MapPin, Users, Leaf, ArrowRight, CheckCircle, Shield } from "lucide-react";
        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 text-white">
          <div className="max-w-lg text-center lg:text-left">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Start Your <span className="text-yellow-300">Agricultural Journey</span> Today
            </h2>
            <p className="text-xl text-white/80 mb-8 leading-relaxed">
              Join thousands of farmers and buyers in building a sustainable agricultural ecosystem.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/90">Connect directly with local communities</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                <span className="text-white/90">Access to fresh, organic marketplace</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
              ...
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                <span className="text-white/90">Free to join, easy to get started</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 p-8 shadow-2xl">
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-white mb-2">Join FarmConnect</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Location Field */}
                <div>
                  <label className="block text-white/90 font-medium mb-3">Location</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                {/* Role Field */}
                <div>
                  <label className="block text-white/90 font-medium mb-3">I am a</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    <select
                      ...
                      value={form.role}
                      onChange={handleChange}
                      className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all backdrop-blur-sm appearance-none cursor-pointer"
                    >
